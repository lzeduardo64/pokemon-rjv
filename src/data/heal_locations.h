...
{
    [HEAL_LOCATION_YURUSITA_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(YURUSITA_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(YURUSITA_TOWN_BRENDANS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_YURUSITA_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(YURUSITA_TOWN_MAYS_HOUSE_2F), MAP_NUM(YURUSITA_TOWN_MAYS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_YURUSITA_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(YURUSITA_TOWN), MAP_NUM(YURUSITA_TOWN), 5, 7},
    [HEAL_LOCATION_YURUSITA_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(YURUSITA_TOWN), MAP_NUM(YURUSITA_TOWN), 5, 7},
    [HEAL_LOCATION_SLAKURG_TOWN - 1] = {MAP_GROUP(SLAKURG_TOWN), MAP_NUM(SLAKURG_TOWN), 22, 20},
