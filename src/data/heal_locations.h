static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_YURUSITA_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(YURUSITA_TOWN), MAP_NUM(YURUSITA_TOWN), 6, 9},
    [HEAL_LOCATION_YURUSITA_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(YURUSITA_TOWN), MAP_NUM(YURUSITA_TOWN), 6, 9},
